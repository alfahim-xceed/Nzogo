...
const VisaList=()=>{
    ...
    const details=[{id:"1",from:"test",to:"text",visa_category:"test"}];

    return (
        <div className="p-6">
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold">Visa List</h2>
                <Link to="/admin/add-visa">
                        ...
                        {details && details.length > 0 ? (
                            details.map((visa, index) => (
                                <tr key={visa.id}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{visa.from}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{visa.to}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{visa.visa_category}</td>
