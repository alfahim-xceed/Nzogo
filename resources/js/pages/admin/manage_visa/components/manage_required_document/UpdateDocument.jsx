...
import { useGetDocumentDetailsQuery, useUpdateDocumentMutation } from '../../../../../services/document_api';
...
const UpdateDocument = () => {
    ...
    const { data: details, isLoading, error } = useGetDocumentDetailsQuery(document_id);
    ...
    const handleSubmit = async (values, { setSubmitting }) => {
        try {
            ...
            await updateDocument({ id: document_id, ...values }).unwrap();
