...
import { useCreateVisaTypeMutation } from '../../../services/visa_type_api';
...
const CreateVisaType = () => {
    ...
    const handleSubmit = async (values, { resetForm }) => {
        ...
        try {
            let { name } = values;
            const res = await createVisaType({ name }).unwrap();
            ...
            console.error(error);
            toast.error("Visa type creation error");
