                ...
                {details && details.length > 0 ? (
                    details.map((cur) => (
                        <div key={cur.id} className="bg-white shadow-md rounded-lg p-4 border border-gray-200 relative">
                            ...
                            <p className="text-sm text-gray-700 mb-1"><strong>Citizen Of:</strong> {cur.country?.name ?? 'N/A'}</p>
                            ...
                            <div className="mt-2">
                                ...
                                <p className="text-sm text-gray-500 mb-1"><strong>Visa for :</strong> {cur?.visa_for ?? 'N/A'}</p>

                                <p className="text-sm text-gray-500 mb-1"><strong>Type:</strong> {cur.visa_type?.name ?? 'N/A'}</p>

                                <p className="text-sm text-gray-500 mb-1"><strong>Fee:</strong> {cur.visa?.fee ?? 'N/A'}</p>
                                <p className="text-sm text-gray-500 mb-1"><strong>Currency:</strong> {cur.visa?.currency ?? 'N/A'}</p>
                                <p className="text-sm text-gray-500 mb-1"><strong>Processing Time:</strong> {cur.visa?.processing_time ?? 'N/A'}</p>
                            </div>
                            <div className="mt-2">
