...
const AppointmentDetails = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg">
            <h1 className="text-xl font-semibold mb-8 text-gray-800 text-center">Appointment Details</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                {/* General Appointment Info */}
                <div className="bg-gray-100 p-4 rounded-lg shadow">
                    <h2 className="text-md font-semibold mb-4 text-gray-700">General Information</h2>
                ...
                {/* Travel Details */}
                <div className="bg-gray-100 p-4 rounded-lg shadow">
                    <h2 className="text-md font-semibold mb-4 text-gray-700">Travel Information</h2>
                    <div className="text-xs space-y-1">
                        <div className="flex items-center mb-4">
                            <img src={country.flag_img_url} alt={`${country.name} flag`} className="w-8 h-8 mr-2" />
            ...
            <div className="bg-gray-100 p-4 rounded-lg shadow mb-8">
                <h2 className="text-md font-semibold mb-4 text-gray-700">User Information</h2>
                <div className="text-xs space-y-1">
